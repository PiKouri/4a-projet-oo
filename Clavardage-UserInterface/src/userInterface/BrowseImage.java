...
public class BrowseImage extends JFrame implements ActionListener {
	private Agent agent;
	private String dest;
	public BrowseImage(Agent agent,String dest){
		this.agent=agent;
		this.dest=dest;
	...
	public void ouvrir() {
		...
		if (i!=1) {
			...
			//agent.sendMessage(dest,new Image(this.agent.getUser(),filename));
		}
	}
